...
spark = SparkSession.builder.appName("Teste1BLinhas").getOrCreate()

df = spark.read.csv(path="csvtest/MCD_yahoo1000M.csv")
...
df.write.parquet('csvtest/MCD_yahoo1B.parquet')