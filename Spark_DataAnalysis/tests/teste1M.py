...
spark = SparkSession.builder.appName("Teste1MLinhasParquet").getOrCreate()

df = spark.read.csv(path="tests/MCD_yahoo1M.csv")

df.show(100000)
df.printSchema()

df.write.parquet('tests/MCD_yahoo1M.parquet')
